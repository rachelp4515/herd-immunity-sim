...
# run one of these commands. Below them is a description of what each number does so you can change them yourself.

# python3 simulation.py 10000 0.78 Flu 0.69 0.31 87
# python3 simulation.py 5000 0.67 Ebola 0.63 0.15 213

# The first number is the amount of people you're running the simulation on. The second is 
# the amount of the population that is already vaccinated. Then there's the name of the sickness. After that is the
# mortality and reproduction rates, and lastly the amount of people that we start the simulation with already infected.
